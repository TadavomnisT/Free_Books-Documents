...
* چه سناریوهای دیگری رو میتونیم تست کنیم که در داده‌های بزرگ بتونی مقایسه رو انجام بدیم؟
...
بیاین صحت این حدس رو بسنجیم، من مقادیر مختلف n رو توی همین دوتا برنامه آخر، یعنی [Iteration_RAM](./Files/Iteration_RAM.cpp) و [Iteration_HDD](./Files/Iteration_HDD.cpp) تست میکنم و نتیجه رو گزارش میکنم. و البته اعتراف کنم که ممکنه یه کار خبیثانه کنم و این آزمایش آخر رو ببرم روی یه VPS انجام بدم که دیسک خودم آسیب نبینه… از طرفی خیلی برای نتیجه مقاله هم خوب هست، چون نتایج آزمایش خیلی overfit نمیشه روی ماشین من.
...
[فایل کد](./Files/Iteration_test.cpp)
