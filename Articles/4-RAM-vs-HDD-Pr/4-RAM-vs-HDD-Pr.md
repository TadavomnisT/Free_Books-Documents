...
![seek-time vs rotational-latency-time](Files/5.jpg)
...
یه کلیپم دارم که یک کپی پبیست ساده در هارد دیسک رو نشون میده، اما نمیدونم منبعش کجاست… اگه میدونید لطفاً بگید!
