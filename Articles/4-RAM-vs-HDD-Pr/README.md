...
منبع عکس [compuclever](https://www.compuclever.com/posts/hard-disk-drive-basics/ic306536/)
...
منبع عکس [schoolcoders](https://www.schoolcoders.com/memory-storage/secondary-storage/hdd/)
...
منبع عکس [slideplayer](https://slideplayer.com/slide/1517076/)
...
یادم نمیاد منبع ای عکس هم کجاست- اگر میدونید خبر بدین!
...
یه کلیپم دارم که یک کپی پبیست ساده در هارد دیسک رو بصورت اسلوموشن نشون میده، آخر مقاله لینکش رو میفرستم.

حرکتی که با چشم قابل دیدن هست و بار دوربین قابل ظبط، قطعا خیلی کند تر از سرعت حرکت الکترونهاست:)
و در کل، بطور متوسط 100 هزاربار کندتر بودن کاملا منطقی هست.
