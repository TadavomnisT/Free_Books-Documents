...
اولاً که چیزی که از نمودار مشهوده، با‌گذشت زمان کندی یه I/O ثابت روی دیسک، حین دسترسی مشترک رشد خطی میکنه، پس میتونیم برونیابی کنیم که با گدشت زمان، زمان نوشتن روی دیسک به این صورت هی کندتر و کندتر میشه، بر خلاف رم که سیر ثابتی رو طی میکنه.
